...
class CenterlineDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            label_np = np.array(label) > 0  # Ensuring binary values
            dilated_label_np = binary_dilation(label_np, iterations=2).astype(np.uint8)
        ...
        return image, label, dilated_label
